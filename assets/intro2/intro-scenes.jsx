    ...
    <div style={{position:'absolute', inset:0, opacity, pointerEvents:'none'}}>
      ...
      <div style={{
        ...
        <span style={{display:'flex',gap:24,opacity:0.55}}>
          <span>Saha Verisi</span>
          <span>Kaynak Modeli</span>
          <span>Risk Analizi</span>
          <span>Karar Raporu</span>
        </span>
  ...
  return (
    <IconShell progress={progress}>
      ...
      <g opacity={clamp((reveal - 0.7) * 3, 0, 1)} transform="translate(820, 920)">
        <text x="0" y="0" fontFamily={T.mono} fontSize="11" letterSpacing="2.5" fill={T.muted}>QA / QC · LAB CHAIN</text>
  ...
  return (
    <IconShell progress={progress}>
      ...
      <g opacity={clamp((reveal - 0.7) * 3, 0, 1)} transform="translate(880, 110)">
        <text x="0" y="0" fontFamily={T.mono} fontSize="11" letterSpacing="3" fill={T.muted}>RESOURCE CONFIDENCE</text>
  ...
  return (
    <IconShell progress={progress}>
      ...
      <g opacity={clamp((reveal - 0.7) * 3, 0, 1)} transform="translate(840, 130)">
        ...
        <text x="16" y="26" fontFamily={T.mono} fontSize="11" letterSpacing="3" fill={T.paper2}>ENVIRONMENTAL MONITORING</text>
